...
public class PictureManagerAddFragment extends Fragment implements CommandPictureManager {
    ...
    private void goToSelectedPictureRowIndex() {
        int pictureRowIndex = PictureManagerAddFragmentArgs.fromBundle(requireArguments()).getPictureRowIndex();
